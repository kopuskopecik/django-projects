...
class Baslik(models.Model):
	...
	def get_absolute_url(self):
		return reverse('front:baslik-index', kwargs={'slug':self.slug},)
...
class Dersler(models.Model):
	...
	def get_absolute_url(self):
		return reverse('front:detail', kwargs={'slug':self.slug, 'slug2':self.baslık.slug})
		
	
	def get_create_url(self):
		return reverse('front:create')
	
	def get_update_url(self):
		return reverse('front:update', kwargs={'slug':self.slug, 'slug2':self.slug2})
	
	def get_delete_url(self):
		return reverse('front:delete', kwargs={'slug':self.slug, 'slug2':self.slug2})
